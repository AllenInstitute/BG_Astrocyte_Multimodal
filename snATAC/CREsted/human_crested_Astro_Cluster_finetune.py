...
##
best_model = "/allen/programs/celltypes/workgroups/rnaseqanalysis/EvoGen/OCTO/aibs-octo-dnaseq-modeling/basal-ganglia/models/crested/evogen-dnaseq-modeling/basal_ganglia/CrestedModelAPI--dilated-cnn-human-basalganglia-astro-cluster--25-06-07-13-02-13/checkpoints/60.keras"
...
adata = ad.read_h5ad(os.path.join(work_dir, "basal-ganglia", "data", species_name, "crested_adata", f"{species_name}_basalganglia_hmba_Astro_cluster_pre-print_crested.h5ad"))
...
adata.write_h5ad(os.path.join(work_dir, "basal-ganglia", "data", species_name, "crested_adata", f"{species_name}_basalganglia_hmba_Astro_cluster_pre-print_crested_finetune.h5ad"))
